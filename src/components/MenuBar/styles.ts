...
export const Container = styled.div`
  ...
  @media (min-width: 500px) {
      ...
      position: sticky; /**Ficar Grudado na tela */
      top: 0;
      left: 0;
...
export const Logo = styled(Twitter)`
    width: 41px;
    height: 41px;
    fill: var(--twitter); /**Cor para o icone */
    margin-bottom: 20px;
`;
...
export const MenuButton = styled.button`
    ...
    & + button {
        ...
        @media (min-width: 1280px){
            width: 100%;
            height: unset; /**Como se nao tivesse mexido no botão tweetar */
            > span {
                display: inline; /**Aparecer o span dnv */
        }
        }
